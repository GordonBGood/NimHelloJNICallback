...
--nimcache:app/src/main/cpp/armeabi-v7a app/src/main/nim/hello_jni_callback
nim c -c -d:noSignalHandler -d:danger -d:release -d:androidNDK ^
--cpu:arm64 --os:android --noMain:on --threads:on ^
--nimcache:app/src/main/cpp/arm64-v8a app/src/main/nim/hello_jni_callback
nim c -c -d:noSignalHandler -d:danger -d:release -d:androidNDK ^
--cpu:i386 --os:android --noMain:on --threads:on ^
--nimcache:app/src/main/cpp/x86 app/src/main/nim/hello_jni_callback
nim c -c -d:noSignalHandler -d:danger -d:release -d:androidNDK ^
--cpu:amd64 --os:android --noMain:on --threads:on ^
--nimcache:app/src/main/cpp/x86_64 app/src/main/nim/hello_jni_callback
