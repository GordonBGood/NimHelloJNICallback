...
NIM_THREADVAR NIM_BOOL envComputed__LLyFo9bsdu1ZXMDvAe8DhrQ;
NIM_THREADVAR tySequence__sM4lkSb7zS6F7OVMvW9cffQ* environment__mlhK49b6YMgc9cgrcYkKq9a3g;
...
N_LIB_PRIVATE N_NIMCALL(void, nossleep)(NI milsecs) {	struct timespec a;
	struct timespec b;
	int T1_;
