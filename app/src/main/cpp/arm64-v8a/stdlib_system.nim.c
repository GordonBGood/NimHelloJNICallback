...
N_LIB_PRIVATE N_NOCONV(void*, allocShared0__WrVG9abV9chlTLqkiXYLKwUg_3)(NI size);
N_LIB_PRIVATE N_NOCONV(void*, allocShared__WrVG9abV9chlTLqkiXYLKwUg_4)(NI size);
...
N_LIB_PRIVATE N_NOCONV(void*, allocShared__WrVG9abV9chlTLqkiXYLKwUg_4)(NI size) {	void* result;
	result = (void*)0;
...
N_LIB_PRIVATE N_NOCONV(void*, allocShared0__WrVG9abV9chlTLqkiXYLKwUg_3)(NI size) {	void* result;
	result = (void*)0;
	result = allocShared__WrVG9abV9chlTLqkiXYLKwUg_4(size);
	zeroMem__FsvhfMqbswETmyMWtamDewsystem(result, size);
	return result;
}
...
N_LIB_PRIVATE N_NIMCALL(tyObject_PtrTablecolonObjectType___lAJk19b9bJwgXR49cf9ctH29blg*, initPtrTable__awRYFsOgLT2QxepuItx23Q)(void) {	tyObject_PtrTablecolonObjectType___lAJk19b9bJwgXR49cf9ctH29blg* result;
	...
	T1_ = (void*)0;
	T1_ = alloc0__WrVG9abV9chlTLqkiXYLKwUg(((NI) 528));
...
N_LIB_PRIVATE N_NIMCALL(void, genericDeepCopyAux__iOYDOwyGohWpJUS4DfUiYg)(void* dest, void* src, TNimNode* n, tyObject_PtrTablecolonObjectType___lAJk19b9bJwgXR49cf9ctH29blg** tab) {	NI d;
	...
	case ((tyEnum_TNimNodeKind__unfNsxrcATrufDZmpBq4HQ) 1):
	{
		genericDeepCopyAux__SUmU9bkE2rxUaiQfnnPnSUQ(((void*) ((NI)((NU64)(d) + (NU64)((*n).offset)))), ((void*) ((NI)((NU64)(s) + (NU64)((*n).offset)))), (*n).typ, tab);
	}
	break;
	case ((tyEnum_TNimNodeKind__unfNsxrcATrufDZmpBq4HQ) 2):
	{
...
N_LIB_PRIVATE N_NIMCALL(tyObject_PtrTablecolonObjectType___lAJk19b9bJwgXR49cf9ctH29blg*, rehash__eWVeXGQWT5uEpbu5jaBwxQ)(tyObject_PtrTablecolonObjectType___lAJk19b9bJwgXR49cf9ctH29blg* t) {	tyObject_PtrTablecolonObjectType___lAJk19b9bJwgXR49cf9ctH29blg* result;
	...
	T1_ = (void*)0;
	T1_ = alloc0__WrVG9abV9chlTLqkiXYLKwUg(((NI) ((NI)(((NI) 16) + (NI)(((NI) 16) * cap)))));
	result = ((tyObject_PtrTablecolonObjectType___lAJk19b9bJwgXR49cf9ctH29blg*) (T1_));
		...
		dst = ((NI) (ptrdiff_t) ((*((void**) (dest)))));
		{
			...
			res = ((NI) 0);
			{
				while (1) {
					...
					i = res;
					genericDeepCopyAux__SUmU9bkE2rxUaiQfnnPnSUQ(((void*) ((NI)((NU64)((NI)((NU64)(dst) + (NU64)((NI)((NU64)(i) * (NU64)((*(*mt).base).size))))) + (NU64)(((NI) 16))))), ((void*) ((NI)((NU64)((NI)((NU64)(((NI) (ptrdiff_t) (s2_2))) + (NU64)((NI)((NU64)(i) * (NU64)((*(*mt).base).size))))) + (NU64)(((NI) 16))))), (*mt).base, tab);
					res += ((NI) 1);
				} LA16: ;
			}
		}
	...
	{
		{
			...
			res_2 = ((NI) 0);
			{
				while (1) {
					...
					i_2 = res_2;
					genericDeepCopyAux__SUmU9bkE2rxUaiQfnnPnSUQ(((void*) ((NI)((NU64)(d) + (NU64)((NI)((NU64)(i_2) * (NU64)((*(*mt).base).size)))))), ((void*) ((NI)((NU64)(s) + (NU64)((NI)((NU64)(i_2) * (NU64)((*(*mt).base).size)))))), (*mt).base, tab);
					res_2 += ((NI) 1);
				} LA27: ;
			}
		}
...
N_LIB_PRIVATE N_NIMCALL(void, createThread__YTuBSuJjGBsPBvdIbGcKog)(tyObject_Thread__gtP9c8k5UKzYjkZfEnGNYRg* t, tyProc__v2sqjMSLaPokKgjL7ewsxw tp, tyObject_TickContext__1qtOMRK8IluFHXVmNYGT9cw* param) {	void* T1_;
	pthread_attr_t a;
	T1_ = (void*)0;
	T1_ = allocShared0__WrVG9abV9chlTLqkiXYLKwUg_3(((NI) 0));
